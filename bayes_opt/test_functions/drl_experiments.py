...
class DRL_experiment:
    def __init__(self, alg_name, env_name, varParams, fixParams = {}, bounds=None, sd=None, gpu_id=None):
        self.env = env_name
    ...
    def evaluate(self, X, unwrap = False):
        ...
        t = 0
        for e in range(N):
            totalrewards[e], t = ag.nextEpisode(env, e, t)
            #print(t, totalrewards[e])
        end_time = time.time()
        elapse = end_time-start_time
        session.close()
        #print(X, totalrewards)
